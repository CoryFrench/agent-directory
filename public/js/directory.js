...
function displayDirectoryData(data) {
    ...
    agentsTbody.innerHTML = data.agents.map(agent => `
        <tr>
            ...
            <td class="contact-links">
                ${agent.facebook_url ? `<a href="${agent.facebook_url}" target="_blank" class="facebook" title="Facebook"><i class="fab fa-facebook"></i></a>` : ''}
                ${agent.linkedin_url ? `<a href="${agent.linkedin_url}" target="_blank" class="linkedin" title="LinkedIn"><i class="fab fa-linkedin"></i></a>` : ''}
                ${agent.goto_url ? `<a href="${agent.goto_url}" target="_blank" class="goto" title="GoTo"><i class="fas fa-external-link-alt"></i></a>` : ''}
            </td>
        </tr>
    `).join('');
    ...
    affiliatedTbody.innerHTML = data.affiliatedBusinesses.map(business => `
        <tr>
            ...
            <td class="contact-links">
                ${business.facebook_url ? `<a href="${business.facebook_url}" target="_blank" class="facebook" title="Facebook"><i class="fab fa-facebook"></i></a>` : ''}
                ${business.linkedin_url ? `<a href="${business.linkedin_url}" target="_blank" class="linkedin" title="LinkedIn"><i class="fab fa-linkedin"></i></a>` : ''}
                ${business.goto_url ? `<a href="${business.goto_url}" target="_blank" class="goto" title="GoTo"><i class="fas fa-external-link-alt"></i></a>` : ''}
            </td>
        </tr>
    `).join('');
    ...
    yachtTbody.innerHTML = data.yachtBrokerage.map(broker => `
        <tr>
            ...
            <td class="contact-links">
                ${broker.facebook_url ? `<a href="${broker.facebook_url}" target="_blank" class="facebook" title="Facebook"><i class="fab fa-facebook"></i></a>` : ''}
                ${broker.linkedin_url ? `<a href="${broker.linkedin_url}" target="_blank" class="linkedin" title="LinkedIn"><i class="fab fa-linkedin"></i></a>` : ''}
                ${broker.goto_url ? `<a href="${broker.goto_url}" target="_blank" class="goto" title="GoTo"><i class="fas fa-external-link-alt"></i></a>` : ''}
            </td>
        </tr>
    `).join('');
}
